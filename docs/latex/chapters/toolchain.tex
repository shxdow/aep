...
\begin{itemize}
  ...
  \item \textbf{Django REST framework}, un framework Python per costruire web API in Django;
...
\begin{itemize}
  ...
  \item \textbf{NPM} e \textbf{Yarn} come package manager per l'ambiente Node, usati per l'installazione delle varie dipdendenze.
\end{itemize}
...
Fra le molte funzionalità, è presente anche la \textit{condivisione live del codice}, in modo da poter
discuterne in real-time e poter usare tecniche di sviluppo agili che richiedono più persone, come il
