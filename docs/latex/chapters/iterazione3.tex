...
Infine, la \textbf{ricerca del gruppo con il punteggio massimo}. Come è possibile intuire facilmente dallo
pseudocodice nell'algoritmo \ref{alg:max-in-dict}, bisogna analizzare una volta ogni gruppo.
