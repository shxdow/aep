...
\begin{figure}
  \centering
  \includegraphics[width=0.9\linewidth]{front-end-ticket-fsm.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{ticket-list-page.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{ticket-new-page.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{ticket-info-page.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{ticket-change-status-page.jpg}
...
I test del front-end consistono in questo istante dello sviluppo a:
\begin{enumerate}
