...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{app-ai-er.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\linewidth]{page-signup.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\linewidth]{back-end-coverage-it1.jpg}
